...
import com.embian.forcemax.twitter.util.NthLastModifiedTimeTracker;
import com.embian.forcemax.twitter.util.SlidingWindowCounter;
...
public class RollingCountBolt extends BaseRichBolt {
	private static final long serialVersionUID = 6206730898923355892L;
